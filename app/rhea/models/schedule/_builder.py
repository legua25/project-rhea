...
def _evaluate(schedule, (inserted, conflicts), total):
...
class ScheduleBuilder(object):
	...
	def _refine(self, subjects, slots):
		...
		return entries
	def _create_solution(self, subjects, slots, tabu_list):
	...
	def _permute_solution(self, entries, subject, conflict, slots, tabu_list, count):
		...
		return entries, (inserted, conflicts)
	def _insert_subject(self, subject, entries, slots, inserted, conflicts, tabu_list, count):
	...
	def __getitem__(self, (subject, day, time)):
